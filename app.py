...
with st.sidebar.expander("🧚‍♀️ ถาม-ตอบ กับไมล่า (Q&A)", expanded=True):
    ...
    if selected_q == "🤔 อยากโพสต์เรื่องราวบ้างต้องทำไง?":
        ...
        st.info("🧚‍♀️ **ไมล่า:** เชื่อไหมคะว่าเว็บนี้เขียนด้วย Python ล้วนๆ รวมแล้วมากกว่า **15,000+ ตัวอักษร** เลยนะ! บอสพิมพ์จนนิ้วล็อกแล้วมั้งเนี่ย 😹")
    elif selected_q == "🤖 บอสใช้ AI ตัวไหนทำงาน?":
        st.success("🧚‍♀️ **ไมล่า:** ความลับ! แต่แอบบอกว่าเบื้องหลังความฉลาดของหนูคือ **Google Gemini 2.0** ค่ะ (บอสจ่ายค่า API จุกๆ เพื่อทุกคนเลยนะ!)")
