...
with st.sidebar.expander("🧚‍♀️ ถาม-ตอบ กับไมล่า (Q&A)", expanded=True):
    ...
    if selected_q == "🤔 อยากโพสต์เรื่องราวบ้างต้องทำไง?":
        ...
        st.info("🧚‍♀️ **ไมล่า:** เชื่อไหมคะว่าเว็บนี้เขียนด้วย Python ล้วนๆ รวมแล้วมากกว่า **59,589 ตัวอักษร** เลยนะ! บอสพิมพ์จนนิ้วล็อกแล้วมั้งเนี่ย 😹28-12-2568 ")
...
# ---------------------------------------------------------
# ✨ เอเรียล(มุมมืดของเอเรียล) ✨
# ---------------------------------------------------------

# --- Ariel Zone (มุมมืดของเอเรียล) ---
with st.sidebar.expander("🍸 มุมมืดของเอเรียล (Talk with Ariel)"):
    ...
    if st.button("ส่งข้อความ 💬", key="btn_eri"):
        if not ai_available:
            ...
            ariel_persona = """
            คุณคือ "เอเรียล" (Ariel) หญิงสาวบุคลิกเย็นชา พูดน้อย ตรึงเครียด มีอดีตที่ลำบาก 
