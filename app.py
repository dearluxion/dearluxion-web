...
with st.expander("🔐 บันทึกลับของเด็กชายเดียร์ (Secret Archive)", expanded=False):
    ...
    with auth_col1:
        birth_input = st.text_input("วันเกิดของคุณ:", type="password", help="ระบุวันเกิดเจ้าของเว็บ")
    with auth_col2:
        secret_key = st.text_input("คีย์ลับลับ:", type="password", help="ระบุรหัสลับจากคนสำคัญ")
